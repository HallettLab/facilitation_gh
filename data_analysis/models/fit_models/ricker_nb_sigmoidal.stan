...
parameters{
  ...
  real alpha_brho; // intraspecific interaction coefficient
...
model{
  ...
  // is this still a good prior for a negative binomial distribution???
  ...
  // do I need to set a prior on the dispersion param??
  // see what Malyon and Lisa have done here
  disp ~ ;
